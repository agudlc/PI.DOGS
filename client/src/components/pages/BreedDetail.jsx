...
export default function BreedDetail() {
    ...
    return ( 
            <div className={styles.divContainerDetail}>
                ...
                <Breed id={breed.id} 
                    name={breed.name} 
                    weight={breed.weightMin !== "NaN" ? 
                    "Min: " + breed.weightMin + " Kg - Max: " + breed.weightMax + " Kg" : "That breed is unmeasurable"}
                    ...
                    height={breed.heightMax !== undefined ? 
                    "Min: " + breed.heightMin + " cm - Max: " + breed.heightMax + " cm" : breed.heightMin + " cm" }
